...
def test_price_history_skips_incomplete_candle():
    ...
    header, rows = YahooFinanceSource(
        "AAPL", include_adjclose=False, session=_FakeSession(payload)
    ).read()
                ...
                "options": [
                    {
                        ...
                        "calls": [
                            {
                                "contractSymbol": "AAPL240118C00190000",
                                "strike": 190.0,
                                "expiration": 1705536000,
                                "lastTradeDate": 1705190400,
                                "lastPrice": 5.1,
                                "bid": 5.0,
                                "ask": 5.2,
                                "change": 0.1,
                        ...
                        "puts": [
                            {
                                "contractSymbol": "AAPL240118P00190000",
                                "strike": 190.0,
                                "expiration": 1705536000,
                                "lastTradeDate": 1705190400,
                                "lastPrice": 4.0,
